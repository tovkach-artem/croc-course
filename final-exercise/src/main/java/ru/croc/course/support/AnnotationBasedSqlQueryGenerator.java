 ...
 */
public class AnnotationBasedSqlQueryGenerator {
     ...
     * переменные, аннотированные {@link Column}, и используя методы {@link AnnotationBasedSqlQueryGenerator#getFieldNames(Field[])}
     * и {@link AnnotationBasedSqlQueryGenerator#getFieldValues(Object, Field[])}  формирует строку запроса INSERT INTO с именами
     ...
     *  {@link AnnotationBasedSqlQueryGenerator#getFieldNames(Field[])} формирует строку запроса SELECT с именами столбцов.
     */
